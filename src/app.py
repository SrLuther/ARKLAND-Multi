...
class ARKServerManagerApp(ctk.CTk):
    ...
    def _build_server_panel(self, parent: ctk.CTkFrame, srv: ServerConfig) -> None:
        ...
        _TAB_BUILDERS = {
            ...
            "🔴 Crashes":   lambda: self._build_tab_crashes    (tabs.tab("🔴 Crashes"),   srv),
        }
    ...
    def _build_tab_plugins(self, parent, srv: ServerConfig) -> None:  # noqa: C901
        ...
        def _refresh_status() -> None:
            ...
            perms_ok   = PluginManager.is_permissions_installed(srv.install_dir)
    ...
    def _build_tab_crashes(self, parent, srv: ServerConfig) -> None:
        ...
        import shutil
        import subprocess
        from .server_manager import _list_crash_records  # type: ignore[attr-defined]
