...
def build_tab_advanced(app: "ARKServerManagerApp", parent, srv: "ServerConfig") -> None:  # noqa: C901
    ...
    # ══════════════════════════════════════════════════════════════════════
    # Linha 0 — Cross-ARK unificado (largura total)
    # ══════════════════════════════════════════════════════════════════════
    from ..ui.cluster_server_section import build_server_cluster_link_legacy
    build_server_cluster_link_legacy(
        app, scroll, srv, w,
        make_card=_make_card,
        head=_head,
        inner_bg=_INNER,
        label_fg=_FORM_LABEL_FG,
        hint_fg=_FORM_HINT_FG,
        font_bold=_FORM_FONT_BOLD,
        font_hint=_FORM_FONT_HINT,
        blue=_BLUE,
        blue_hover=_BLUE_HOVER,
    )
