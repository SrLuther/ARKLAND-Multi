...
BREEDING_DATA: list[tuple] = [
    # (nome, tipo, mating_s, incub_ou_gest_s, maturation_s)  -- incubação atualizada via Beacon DevKit API (authoritative)
    # ── Egg layers ─────────────────────────────────────────────────────────
    ("Allosaurus",           "egg",      5940,       6000,   166620),
    ("Ankylosaurus",         "egg",      9420,       9473,   176580),
    ("Araneo",               "egg",      5100,       9000,    90060),
    ("Archaeopteryx",        "egg",      9420,       9473,    55500),
    ("Argentavis",           "egg",     10560,      10587,   202020),
    ("Arthropluera",         "egg",      8940,      18480,   185760),
    ("Baryonyx",             "egg",      7140,       7199,   166620),
    ("Beelzebufo",           "egg",     17940,      17999,   133920),
    ("Bloodstalker",         "egg",     10560,      19560,   202020),
    ("Brontosaurus",         "egg",     17940,      17999,   333300),
    ("Carbonemys",           "egg",      4440,       4500,    83280),
    ("Carcharodontosaurus",  "egg",    180540,     179940,   109200),  # incub. confirmado via Beacon DevKit; mat. efetiva (blueprint 8x interno ASE)
    ("Carnotaurus",          "egg",      5940,       6000,   166620),
    ("Compy",                "egg",      2940,       3000,    75720),
    ("Crystal Wyvern",       "egg",     17940,      17999,   333300),
    ("Deinonychus",          "egg",     17940,      17999,   133920),
    ("Dilophosaur",          "egg",      4080,       4091,    75720),
    ("Dimetrodon",           "egg",      8940,       8999,   166620),
    ("Dimorphodon",          "egg",      4860,       4864,    90060),
    ("Dodo",                 "egg",      2940,       3000,    55500),
    ("Featherlight",         "egg",      5940,      17520,   176580),
    ("Fjordhawk",            "egg",      5940,      16620,   166620),
    ("Gallimimus",           "egg",      5100,       5142,    94020),
    ("Giganotosaurus",       "egg",    180540,     179940,   878340),
    ("Glowtail",             "egg",      8940,      17520,   176580),
    ("Hesperornis",          "egg",      5400,      10080,   100980),
    ("Ichthyornis",          "egg",      5940,      13320,   133920),
    ("Iguanodon",            "egg",      5100,       5142,   166620),
    ("Kairuku",              "egg",      5400,       5454,   100980),
    ("Kaprosuchus",          "egg",      7140,       7199,   133920),
    ("Kentrosaurus",         "egg",      9960,       9999,   185760),
    ("Lymantria",            "egg",      5400,      11100,   111660),
    ("Lystrosaurus",         "egg",      2940,       3000,    55500),
    ("Magmasaur",            "egg",     17940,      66660,   666660),
    ("Mantis",               "egg",      9960,      19560,   202020),
    ("Megalania",            "egg",      7140,       7199,   133920),
    ("Megalosaurus",         "egg",      5940,       6000,   333300),
    ("Microraptor",          "egg",      5100,       5142,   202020),
    ("Morellatops",          "egg",      8940,      11100,   111660),
    ("Moschops",             "egg",      9420,       9473,   176580),
    ("Oviraptor",            "egg",      4080,       7560,    75720),
    ("Pachy",                "egg",      5100,       5142,    94020),
    ("Pachyrhinosaurus",     "egg",      8940,       8999,   166620),
    ("Parasaur",             "egg",      5100,       5142,    94020),
    ("Pegomastax",           "egg",      4080,       4091,   111660),
    ("Pelagornis",           "egg",      5940,       6000,   133920),
    ("Pteranodon",           "egg",      5940,       6000,   133920),
    ("Pulmonoscorpius",      "egg",      7140,      13320,   133920),
    ("Quetzal",              "egg",     59940,      59995,   476160),
    ("Raptor",               "egg",      7140,       7199,   133920),
    ("Rex",                  "egg",     17940,      17999,   333300),
    ("Rock Drake",           "egg",     22440,      33300,   333300),
    ("Sarco",                "egg",      8940,       8999,   166620),
    ("Sinomacrops",          "egg",      9420,      13320,   133920),
    ("Snow Owl",             "egg",     10560,      10587,   202020),
    ("Spino",                "egg",     13800,      13845,   255780),
    ("Stegosaurus",          "egg",      9960,       9999,   185760),
    ("Tapejara",             "egg",      5940,       6000,   202020),
    ("Terror Bird",          "egg",      7140,       7199,   166620),
    ("Therizinosaur",        "egg",      5940,       6000,   415440),
    ("Thorny Dragon",        "egg",      8940,      17520,   176580),
    ("Triceratops",          "egg",      8940,       8999,   166620),
    ("Troodon",              "egg",      4080,       4091,    75720),
    ...
    ("Yutyrannus",           "egg",     17940,      17999,   666660),
    # ── Mammals ────────────────────────────────────────────────────────────
